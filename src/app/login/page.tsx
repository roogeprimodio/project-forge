...
// Placeholder for Lottie animation component (user would need to install a library like react-lottie-player)
const LottieAnimationPlaceholder = ({ className }: { className?: string }) => (
  <div className={`bg-muted/30 rounded-lg flex items-center justify-center aspect-square ${className}`} data-ai-hint="login security animation">
    {/* In a real app, you'd use a Lottie player here, e.g., <LottiePlayer animationData={animationJson} /> */}
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-primary/10 via-background to-accent/10">
            <Card className="w-full max-w-4xl shadow-2xl grid md:grid-cols-2 overflow-hidden rounded-xl border-primary/20">
                {/* Left Side: Lottie Animation / Branding (Hidden on small screens) */}
                <div className="hidden md:flex flex-col items-center justify-center bg-primary p-8 text-primary-foreground">
                    <LogIn className="w-20 h-20 mb-6" />
                    <h2 className="text-3xl font-bold mb-3 text-center">Access Your Projects</h2>
                    <p className="text-center text-primary-foreground/80 mb-8">
                        Securely log in to manage and create amazing project reports with AI assistance.
                    </p>
                    <LottieAnimationPlaceholder className="w-full max-w-xs" />
                     <p className="text-xs mt-8 text-primary-foreground/60">
                ...
                <div className="flex flex-col justify-center p-6 sm:p-10">
                    <CardHeader className="text-center p-0 mb-6 sm:mb-8">
                        ...
                        <CardTitle className="text-2xl sm:text-3xl font-bold text-primary text-glow-primary">Welcome Back!</CardTitle>
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link href="#" className="text-xs text-primary hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring rounded-sm">
                                        Forgot Password?
                                    </Link>
                                </div>
                                <div className="relative">
                                    <Input
                                        ...
                                        required
                                        className="focus-visible:glow-primary h-10 text-sm pr-10"
                                    />
                                    <Button
                                        type="button"
                                        variant="ghost"
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <div className="flex items-center gap-2">
                                    <Button
                                      ...
                                      variant="ghost"
                                      size="sm"
                                      className={`p-0 h-auto hover:bg-transparent ${rememberMe ? 'text-primary' : 'text-muted-foreground'}`}
                                      onClick={() => setRememberMe(!rememberMe)}
                                    >
                                      <CheckSquare className={`h-5 w-5 mr-1.5 transition-colors ${rememberMe ? 'fill-primary text-primary-foreground' : 'fill-muted'}`} />
                                      Remember me
                                    </Button>
                                </div>
                            </div>
                    ...
                    <div className="my-6">
                        <Separator />
                        <p className="text-center text-xs text-muted-foreground bg-background px-2 relative -top-2.5 mx-auto w-fit">OR CONTINUE WITH</p>
                    </div>
                    ...
                    <CardFooter className="p-0 mt-6 sm:mt-8 text-center">
                        <p className="text-xs text-muted-foreground w-full">
                            ...
                            <Link href="/register" className="font-semibold text-primary hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring rounded-sm">
                                Sign Up
                            </Link>
                        </p>
                    </CardFooter>
